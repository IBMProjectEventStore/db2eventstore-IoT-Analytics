...
+ node test.js --engine=zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:9177 --server=https://zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:443 --user=admin --password=password --namespace=zen --deployment-id=db2eventstore-1630513601941818
Using Engine: zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:9177
...
(node:307) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
Token from IDP Cluster successfully retrieved:
==========================
eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..r4zv8631o6lnn_mAzqM5T2dBXG4csyVw1wmk-BTQpjce_dsGCxdhTPW9UW8L-V5zOuPNnMAjK9xeS1iFA5QaxO7I33KPYqa-VpBKS_4VFMqrQOby0HM_okdDG85Z_SWZVDHAyEephOIKdoRIQ1Y8EvXVliOotiwtILjtuZYw0SLY-eiQkUlKYtbqVUuK20ADlVLNb3IOYksGvCSXfufaSvYTpDZ5Mfp6Z3OmzoPuFJHdpzZVRl7MjzxdttvvuwxLjxxvdNjqJeyeocDUtzSqvQ3TPj0VlzvUoP7mG5vxNlL3_YSxWcLzPe6ZzLsHhkPT5aDJQF73XydhawmDw_xL8A
==========================
...
https://zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:443/icp4data-databases/db2eventstore-1630513601941818/zen/com/ibm/event/api/v1/init/engine?engine=zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:9177
==========================
==========================
URL Called -> https://zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:443/icp4data-databases/db2eventstore-1630513601941818/zen/com/ibm/event/api/v1/init/engine?engine=zen-cpd-zen.apps.stroud-es-2010-os-4631.cp.fyre.ibm.com:9177
** Received response **
