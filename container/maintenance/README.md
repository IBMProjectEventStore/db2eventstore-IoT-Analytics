...
Go to this <a href="https://github.com/nodesource/distributions#installation-instructions-1/" target="_blank">link</a> to determine how to modify the above line for new versions of Node.js (our docker image is UBI 8 which is based off Red Hat 8). <br>
