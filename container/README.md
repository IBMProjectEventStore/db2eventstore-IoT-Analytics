...
#### Install Docker
On either:
- Mac OS 11.4 & 11.5.2 and [docker desktop](https://www.docker.com/products/docker-desktop) (tested with Docker version `20.10.7, build f0df350` MacBook Pro 16 inch 2019 model) installed and running or;
