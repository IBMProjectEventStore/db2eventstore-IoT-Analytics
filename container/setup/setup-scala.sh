...
## dl.bintray.com is going away.  Installs version 1.5.6 of SBT from github.com.

wget -O /tmp/sbt-1.5.6.tgz https://github.com/sbt/sbt/releases/download/v1.5.6/sbt-1.5.6.tgz
tar xzvf /tmp/sbt-1.5.6.tgz -C /usr/share/
